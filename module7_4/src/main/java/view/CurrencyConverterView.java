                ...
                try {
                    ...
                    if (amountText.isEmpty()) {
                        ...
                        if (convertFromField.getValue() == null || convertToField.getValue() == null) {
                            ...
                            CurrencyConverter currencyFrom = (CurrencyConverter) convertFromField.getValue();
                            double convertedAmount = controller.convertFromUSD(amount, currencyFrom.getCode());
                            CurrencyConverter currencyTo = (CurrencyConverter) convertToField.getValue();
                            convertedAmount = controller.convertToUSD(convertedAmount, currencyTo.getCode());
                            ...
                            transaction.setSourceCurrency(currencyFrom);
                            transaction.setTargetCurrency(currencyTo);
