...
public class CurrencyConverterView extends Application {
    ...
    public void setNoticeLabel(String amount) {
        noticeLabel.setText("Notice: " + amount);
    }

    public void addToConvertFromField(String key) {
        convertFromField.getItems().add(key);
    }
    public void addToConvertToField(String key) {
        convertToField.getItems().add(key);
    }
    public void start(Stage window) {
        ...
        controller.addCurrency("USD", 1.0);
        controller.addCurrency("EUR", 0.94);
        controller.addCurrency("GBP", 0.80);
        controller.addCurrency("SEK", 10.88);
